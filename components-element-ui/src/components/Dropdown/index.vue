<template>
  <el-dropdown ref="dropdown" v-bind="$attrs" :trigger="internalTrigger" :placement="placement" @command="handleCommand" @visible-change="handleVisibleChange">
    ...
    <el-dropdown-menu ref="dropdownMenu" slot="dropdown" class="no-dropdown-arrow margin-6-0" @contextmenu.native.prevent>
      <slot name="dropdown">
        <el-dropdown-item class="option-item" :divided="option.divided" v-for="option in optionsFilter" :key="option[defaultProps.value]" :disabled="option.disabled" :command="option">
