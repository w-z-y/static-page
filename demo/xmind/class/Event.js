export default class Event {
  ...
  setupContainerEvent() {
    ...
    this.mindmap.container.addEventListener("click", (e) => {
      if (
        e.target === this.mindmap.container ||
        e.target === this.mindmap.wrapper
      ) {
  ...
  setupWheelEvent() {
    ...
    this.mindmap.container.addEventListener("wheel", handleWheel, {
      passive: false,
    });
  }
  ...
  setupTouchEvent() {
    ...
    this.mindmap.container.addEventListener("touchmove", (e) => {
      ...
      if (e.touches.length === 2) {
        ...
        const x =
          (midX - rect.left - this.mindmap.offsetX) / this.mindmap.scale;
